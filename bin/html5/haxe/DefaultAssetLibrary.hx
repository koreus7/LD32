...
class DefaultAssetLibrary extends openfl.AssetLibrary {
	...
	public function new() {
		super();
		// register assets:
		add("graphics/debug/console_debug.png", IMAGE);
		add("graphics/debug/console_hidden.png", IMAGE);
		add("graphics/debug/console_logo.png", IMAGE);
		add("graphics/debug/console_output.png", IMAGE);
		add("graphics/debug/console_pause.png", IMAGE);
		add("graphics/debug/console_play.png", IMAGE);
		add("graphics/debug/console_step.png", IMAGE);
		add("graphics/debug/console_visible.png", IMAGE);
		add("graphics/preloader/haxepunk.png", IMAGE);
		add("font/04B_03__.ttf", FONT);
		add("font/04B_03__.ttf.png", IMAGE);
		add("graphics/player.png", IMAGE);
		add("font/04B_03__.ttf", FONT);
		//
	}
