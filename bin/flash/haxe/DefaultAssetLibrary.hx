...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("audio/orbbotbeep.mp3", AssetType.MUSIC);
		className.set ("audio/orbotdie.mp3", __ASSET__audio_orbotdie_mp3);
		type.set ("audio/orbotdie.mp3", AssetType.MUSIC);
		className.set ("audio/powerup.mp3", __ASSET__audio_powerup_mp3);
		...
		id = "audio/orbbotbeep.mp3";
		path.set (id, id);
		
		type.set (id, AssetType.MUSIC);
		id = "audio/orbotdie.mp3";
		path.set (id, id);
		
		type.set (id, AssetType.MUSIC);
		id = "audio/powerup.mp3";
		path.set (id, id);
...
@:image("C:/HaxeToolkit/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_debug.png") #if display private #end class __ASSET__graphics_debug_console_debug_png extends lime.graphics.Image {}
@:image("C:/HaxeToolkit/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_hidden.png") #if display private #end class __ASSET__graphics_debug_console_hidden_png extends lime.graphics.Image {}
@:image("C:/HaxeToolkit/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_logo.png") #if display private #end class __ASSET__graphics_debug_console_logo_png extends lime.graphics.Image {}
@:image("C:/HaxeToolkit/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_output.png") #if display private #end class __ASSET__graphics_debug_console_output_png extends lime.graphics.Image {}
@:image("C:/HaxeToolkit/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_pause.png") #if display private #end class __ASSET__graphics_debug_console_pause_png extends lime.graphics.Image {}
@:image("C:/HaxeToolkit/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_play.png") #if display private #end class __ASSET__graphics_debug_console_play_png extends lime.graphics.Image {}
@:image("C:/HaxeToolkit/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_step.png") #if display private #end class __ASSET__graphics_debug_console_step_png extends lime.graphics.Image {}
@:image("C:/HaxeToolkit/haxe/lib/HaxePunk/2,5,3/assets/graphics/debug/console_visible.png") #if display private #end class __ASSET__graphics_debug_console_visible_png extends lime.graphics.Image {}
